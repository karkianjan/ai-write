  ...
  return (
    <div className="top-0 z-10 flex w-full h-[88px] bg-gray-100 items-center justify-end  px-6 py-3.5 lg:gap-28">
      ...
      <div className="flex flex-row  gap-6">
        <div className="pt-2">
          <ul className="flex flex-row gap-5 items-center ">
            {filteredItems.map((item, index) => (
              <li
                key={item.id}
                className={classNames("group relative flex flex-row")}
              >
                <item.icon />
              </li>
            ))}
        ...
        <div className="border-t-2 h-[45px] w-[2px] bg-gray-400 rotate90"></div>
        ...
        <div>
          <Button
            ...
            className="ml-auto min-w-0"
          >
            <div className="size-10 shrink-0 rounded-full bg-inputBorder p-0 flex justify-center items-center text-customGreen">
              Logout
            </div>
          </Button>
        </div>
